...
class Core {
	...
	public function registerAssets() {
		wp_enqueue_script( 'jquery-fancybox', static::$plugin_url . 'assets/js/jquery.fancybox.min.js', array( 'jquery' ), static::$fancybox_version, true );
		wp_enqueue_style( 'jquery-fancybox', static::$plugin_url . 'assets/css/jquery.fancybox.min.css', false, static::$fancybox_version, 'screen' );
	}
